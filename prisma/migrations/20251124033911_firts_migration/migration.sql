...
INSERT INTO "new_User" ("avatarUrl", "coupleId", "createdAt", "email", "id", "name", "password", "updatedAt") SELECT "avatarUrl", "coupleId", "createdAt", "email", "id", "name", "password", "updatedAt" FROM "User";
DROP TABLE "User";
